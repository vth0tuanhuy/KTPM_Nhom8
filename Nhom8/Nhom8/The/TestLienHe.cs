...
namespace Nhom8.The
{
    ...
    public class TestLienHe
    {
        ...
        //đầy đủ các trường
        [Test]
        public void TC06_ĐayDuCacTruong()
        {
        ...
        [Test]
        public void TC07_TrongTruongLoiNhan()
        {
            // 1. Truy cập vào trang liên hệ
            driver.Navigate().GoToUrl(testLienhe);
            // 2. Điền thông tin vào các trường
        ...
        //trống trường họ tên
        [Test]
        public void TC08_TrongTruongHoTen()
        {
            // 1. Truy cập vào trang liên hệ
            driver.Navigate().GoToUrl(testLienhe);
            // 2. Điền thông tin vào các trường
        ...
        //trống trường email
        [Test]
        public void TC09_TrongTruongEmail()
        {
        ...
        [Test]
        public void TC10_TrongTatCaCacTruong()
        {
