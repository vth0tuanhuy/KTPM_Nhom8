...
namespace Tuan
{
    ...
    internal class TestChiTiestSanPham
    {
        ...
        [Test]
        public void TC16_xemChiTietSanPhamTheoDanhMuc()
        {
            // Vào trang chủ
        ...
        [Test]
        public void TC17_xemChiTietSanPhamTheoSize()
        {
            // Vào trang chủ
            driver.Navigate().GoToUrl(Url);
        ...
        [Test]
        public void TC18_xemChiTietSanPham()
        {
            // Vào trang chủ
            driver.Navigate().GoToUrl(Url);
        ...
        [Test]
        public void TC19_xemChiTietSanPhamTheoDanhMucVaSize()
        {
            // Vào trang chủ
            driver.Navigate().GoToUrl(Url);
        ...
        [Test]
        public void TC20_xemChiTietSanPhamGiaCaoNHat()
        {
            // Vào trang chủ
            driver.Navigate().GoToUrl(Url);
            ...
            IWebElement checkboxOption = driver.FindElement(By.XPath("//*[@id=\"wrapper\"]/div/div/div[2]/form/select"));
            checkboxOption.Click();
            Thread.Sleep(5000);

            // Chọn option hiển thị
            IWebElement checkboxPrice = driver.FindElement(By.XPath("//*[@id=\"wrapper\"]/div/div/div[2]/form/select/option[5]"));
            checkboxPrice.Click();
            Thread.Sleep(2000);

            // Click vào sản phẩm đầu tiên theo bảng mới nhất
            IWebElement sanPham = driver.FindElement(By.CssSelector(".products .product:nth-child(1) .box-image"));
            sanPham.Click();
            Thread.Sleep(2000);
